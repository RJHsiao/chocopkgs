...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/616.56/616.56-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = 'da50178def40a17c40d7b4622003b2073efd20c9422d0bb707bc7e59e8cc4868'
